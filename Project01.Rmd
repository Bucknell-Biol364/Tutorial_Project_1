...
###The code below is used to explain how to create a graph with two variables. Here we are using ggplot to show how Absorbance and Phosphorus levels interact.
```{r}
 ggplot(summer21clean, aes(x = Time, y = Phosphorus)) +
  geom_point(position = "jitter",size=0.05) + 
  geom_smooth(method='lm',se=FALSE) + 
  ggtitle('C:  Time vs Phosphorus') +
  theme_cowplot()
